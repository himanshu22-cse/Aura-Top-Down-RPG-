...
void AAuraCharacter::MulticastLevelUpParticles_Implementation() const
{
	...
	{
		const FVector CameraLocation = TopDownCameraComponent->GetComponentLocation(); 	// As we want lambda to be executed by each ability.
...
void AAuraCharacter::SaveProgress_Implementation(const FName& CheckpointTag)
{
	...
	if (AuraGameMode)
	{
		...
		*/
		...
		// As we want lambda to be executed by each ability.
