...
void UAuraBeamSpell::StoreMouseDataInfo(const FHitResult& HitResult)
{
	...
	else // If Hit Result does not get a valid blocking hit ,we cancel ability
	{
...
void UAuraBeamSpell::StoreOwnerVariables()
{
	if (CurrentActorInfo)
	{
		OwnerPlayerController = CurrentActorInfo->PlayerController.Get();  // Since Player Controller is a weak ptr ,so we call get on it
